  ...
  return (
    <>
      ...
      <motion.div variants={staggerContainer} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.25 }}>
        ...
        <div className='container-fluid py-10 hidden lg:inline'>
                ...
                <div className="col-sm-12 col-md-12 col-lg-7 ">
                  <Card className='p-5 bg-color-primary border-0'>
                    ...
                    <Form className="p-2 sm:p-4" form={form} onFinish={submitEmai} layout="vertical" hideRequiredMark>
                      ...
                      <div className="row">
                        <div className='col-sm col-md col-lg'>
                          <Button className='rounded-0 bg-white text-color-secondary font-bold w-75 hover:bg-color-primary border-0' htmlType='submit' > SUBMIT NOW</Button>
                        </div>
      ...
      <div className="container-fluid  bgPicture  inline-flex lg:hidden">
        {/* Welcome Section Products */}
      ...
      <div className="block lg:hidden">
        ...
        <div className="row g-0 ">
          <div className="col-sm-12 col-md-12 col-lg ">
            <Card className='bg-color-primary border-0'>
              <div className="row">
                <div className="col-sm col-md col-lg">
          ...
          <div className="col-sm-12 col-md-12 col-lg bg-color-secondary ">
